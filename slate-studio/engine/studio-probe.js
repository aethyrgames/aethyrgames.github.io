...
var ASM_CONSTS = {
  2041544: ($0) => { console.error(UTF8ToString(Number($0))); },  
 2041589: () => { return navigator.hardwareConcurrency || 1; },  
 2041636: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 2041783: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
