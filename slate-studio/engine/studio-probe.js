...
var ASM_CONSTS = {
 ...
 2046921: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 2047004: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 2047073: () => { return window.innerWidth; },  
 2047103: () => { return window.innerHeight; }
};
